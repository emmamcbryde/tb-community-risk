...
st.title("Run Model")
st.caption(
    "Runs the normal core epidemiological APY workflow with the Python APY backend by default "
    "and stores the portable results bundle."
)
...
st.caption(
    ...
    + (
        ...
        else " | Python APY backend default"
    )
)
if status.get("error"):
