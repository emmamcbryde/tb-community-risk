...
def _write_scenario_inputs(
    ...
    rows = [
        ...
        ("LTBI-state model", ltbi_state.get("transitionModel")),
        ("recent-to-remote transition rate", ltbi_state.get("recentToRemoteTransitionRatePerYear"), "per year"),
        ("recent-state implied mean residence time", ltbi_state.get("impliedMeanResidenceTimeYears"), "years"),
...
def _write_technical_metadata(
    ...
    rows = [
        ...
        ("ltbiState.transitionModel", ltbi_state.get("transitionModel")),
