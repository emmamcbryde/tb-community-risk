...
class ClinicianOpeningNavigationTests(unittest.TestCase):
    def test_opening_page_visible_text_avoids_implementation_terms(self) -> None:
        ...
        self.assertIn("Restore APY defaults", visible_text)
        self.assertIn("Parameters", visible_text)
        self.assertNotIn("Use default parameters", visible_text)
        self.assertNotIn("Review or change parameters", visible_text)
        self.assertNotIn("Continue to current results", visible_text)
